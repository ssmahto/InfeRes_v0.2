...
of the `Google Earth Engine data collection `Landsat <https://developers.google.com/earth-engine/datasets/catalog/landsat/>`_, `Sentinel <https://developers.google.com/earth-engine/datasets/catalog/sentinel/>`_, and
